...
4. _For production use the following command to make the build:_

```bash
npm run build
```

**Now you will have the <font color="#e20e02">dist</font> folder inside the root directory.**
...
3. **Upload Files:**
   - _Navigate to the local directory where your project's build files are located (e.g., the "**<font color="e20e02">dist</font>**" folder)._
